import {
  ...
  useLabelableContext,
  useLabelableId
} from "./chunk-Y3TBXDNJ.js";
import {
  getDisabledMountTransitionStyles,
  useAnchorPositioning,
  useToolbarRootContext
} from "./chunk-2EY3JJKS.js";
import {
  clamp,
  styleDisableScrollbar,
  useCSPContext
} from "./chunk-WN65M6MG.js";
import "./chunk-66B4SL4N.js";
import {
  COMPOSITE_KEYS,
  ...
  visuallyHidden,
  visuallyHiddenInput
} from "./chunk-DTNIXKXZ.js";
import "./chunk-RRPU7KTZ.js";
import {
...
import {
  useButton
} from "./chunk-S5KIYYHS.js";
import "./chunk-HQPNHHNY.js";
import {
  getWindow,
  useIsoLayoutEffect,
  useStableCallback
} from "./chunk-X5S3FH6F.js";
import {
...
var CompositeListContext = React11.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function CompositeList(props) {
  ...
  const [mapTick, setMapTick] = React12.useState(0);
  const lastTickRef = React12.useRef(mapTick);
  ...
  const sortedMap = React12.useMemo(() => {
...
var SelectPositionerContext = React13.createContext(void 0);
if (true) SelectPositionerContext.displayName = "SelectPositionerContext";
function useSelectPositionerContext() {
  const context = React13.useContext(SelectPositionerContext);
  if (!context) {
...
var SelectPositioner = React14.forwardRef(function SelectPositioner2(componentProps, forwardedRef) {
  const {
    anchor,
  ...
  const transitionStatus = useStore(store, selectors.transitionStatus);
  const scrollUpArrowRef = React14.useRef(null);
  const scrollDownArrowRef = React14.useRef(null);
  const [controlledAlignItemWithTrigger, setControlledAlignItemWithTrigger] = React14.useState(alignItemWithTrigger);
  ...
  React14.useImperativeHandle(alignItemWithTriggerActiveRef, () => alignItemWithTriggerActive);
  ...
  const defaultProps = React14.useMemo(() => {
    const hiddenStyles = {};
    if (!open) {
  ...
  const prevMapSizeRef = React14.useRef(0);
...
function useCompositeListItem(params = {}) {
  ...
  const [index, setIndex] = React17.useState(externalIndex ?? (indexGuessBehavior === IndexGuessBehavior.GuessFromOrder ? () => {
...
var SelectItemContext = React18.createContext(void 0);
if (true) SelectItemContext.displayName = "SelectItemContext";
function useSelectItemContext() {
  const context = React18.useContext(SelectItemContext);
  if (!context) {
...
var SelectItem = React19.memo(React19.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  rootProps.id = void 0;
  const lastKeyRef = React19.useRef(null);
  const pointerTypeRef = React19.useRef("mouse");
  const didPointerDownRef = React19.useRef(false);
  const {
    getButtonProps,
    buttonRef
  } = useButton({
...
var SelectItemIndicator = React20.forwardRef(function SelectItemIndicator2(componentProps, forwardedRef) {
...
var Inner = React20.memo(React20.forwardRef((componentProps, forwardedRef) => {
  const {
    render,
    className,
    keepMounted,
  ...
  const indicatorRef = React20.useRef(null);
  const {
    transitionStatus,
    setMounted
...
var SelectItemText = React21.memo(React21.forwardRef(function SelectItemText2(componentProps, forwardedRef) {
  const {
    indexRef,
    textRef,
    selectedByFocus,
  ...
  const localRef = React21.useCallback((node) => {
...
var SelectArrow = React22.forwardRef(function SelectArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var SelectScrollArrow = React23.forwardRef(function SelectScrollArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    direction,
...
var SelectScrollDownArrow = React24.forwardRef(function SelectScrollDownArrow2(props, forwardedRef) {
...
var SelectScrollUpArrow = React25.forwardRef(function SelectScrollUpArrow2(props, forwardedRef) {
...
var SelectGroupContext = React26.createContext(void 0);
if (true) SelectGroupContext.displayName = "SelectGroupContext";
function useSelectGroupContext() {
  const context = React26.useContext(SelectGroupContext);
  if (context === void 0) {
...
var SelectGroup = React27.forwardRef(function SelectGroup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
  } = componentProps;
  const [labelId, setLabelId] = React27.useState();
...
var SelectGroupLabel = React28.forwardRef(function SelectGroupLabel2(componentProps, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
...
var Separator = React29.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
